      ...
      <div className="modal-content" style={contentStyle}>
        ...
        <div style={stepContainerStyle}>
          <div style={{ ...stepStyle, ...activeStepStyle }}>
            <span style={stepNumActiveStyle}>1</span> <span style={stepTextStyle}>Image OS</span>
          </div>
        ...
        <form onSubmit={(e) => { e.preventDefault(); onClose(); }} style={formStyle}>
          <div className="form-group" style={formGroupStyle}>
            <label style={labelStyle}>Nom de la VM</label>
            <input type="text" style={inputStyle} placeholder="vm-projet-ornella" />
          </div>

          <div className="form-group" style={formGroupStyle}>
            <label style={labelStyle}>Image OS</label>
          ...
          <div style={rowStyle}>
            <div className="form-group" style={{ ...formGroupStyle, flex: 1 }}>
              ...
              <input type="number" style={inputStyle} defaultValue="4" />
            </div>
            <div className="form-group" style={{ ...formGroupStyle, flex: 1 }}>
              <label style={labelStyle}>RAM (Go)</label>
              <input type="number" style={inputStyle} defaultValue="8" />
            </div>
            <div className="form-group" style={{ ...formGroupStyle, flex: 1 }}>
          ...
          <div className="form-group" style={formGroupStyle}>
            ...
            <input type="number" style={inputStyle} defaultValue="100" />
          </div>
