      ...
      <div className="profil-layout">
        ...
        <div className="prof-left">
          ...
          <div className="pro-card">
            ...
            <div className="pro-name">Ornella MBO'O</div>
            <div className="pro-email">ornella.mboo@enspy.cm</div>
            ...
            <div className="pro-stats">
              <div className="pro-stat-box">
                <div className="pro-stat-val">3</div>
                <div className="pro-stat-lbl">VMs Actives</div>
              </div>
              <div className="pro-stat-box">
                <div className="pro-stat-val">12</div>
                <div className="pro-stat-lbl">VMs Créées</div>
              </div>
              <div className="pro-stat-box">
                <div className="pro-stat-val">47<span style={{ fontSize: '14px' }}>h</span></div>
                <div className="pro-stat-lbl">Temps Total</div>
              </div>
              <div className="pro-stat-box">
                <div className="pro-stat-val">8<span style={{ fontSize: '14px' }}>Go</span></div>
            ...
            <div className="pm-body">
              <div className="pm-row">
                <div className="pm-field">
                  ...
                  <div className="pm-input-wrap">
                    ...
                    <input className="pm-input" type="text" defaultValue="MBO'O" />
                  </div>
                </div>
                <div className="pm-field">
                  ...
                  <div className="pm-input-wrap">
                    <svg className="pm-input-icon" viewBox="0 0 24 24"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                    <input className="pm-input" type="text" defaultValue="Ornella" />
                  </div>
                </div>
              </div>
              <div className="pm-field">
                ...
                <div className="pm-input-wrap">
                  ...
                  <input className="pm-input" type="text" defaultValue="ENSPY — Département INFO" disabled />
              ...
              <div className="pm-field">
                ...
                <div className="pm-input-wrap">
                  ...
                  <input className="pm-input" type="text" defaultValue="Étudiante — Master 2" disabled />
                  <div className="pm-input-badge">ADMIN ONLY</div>
                </div>
              </div>
              <div className="pm-alert">
                <svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>
                <p>Le nom, l'organisation et le statut ne peuvent être modifiés que par un administrateur. Contactez l'équipe SIGMA pour toute correction.</p>
              </div>
            </div>
          </div>
            ...
            <div className="pm-body">
              <div className="pm-field">
                ...
                <div className="pm-input-wrap">
                  ...
                  <input className="pm-input" type="text" defaultValue="ornella.mboo@enspy.cm" disabled />
                </div>
              </div>
              <div className="pm-field">
