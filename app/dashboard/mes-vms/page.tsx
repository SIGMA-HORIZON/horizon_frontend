  ...
  return (
    <div className="page active">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px' }}>
        <div>
        <h1 style={{ fontSize: '28px', fontWeight: '800', letterSpacing: '-0.5px', color: 'var(--g1-text)' }}>Mes Machines Virtuelles</h1>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(340px, 1fr))', gap: '24px' }}>
            ...
            >
              <div style={{ padding: '24px', flex: 1 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '20px' }}>
                  <div style={{ background: 'var(--g1-nav)', padding: '10px', borderRadius: '8px', border: '1px solid var(--g1-border)' }}>
                    <div style={{ fontSize: '10px', color: 'var(--g1-muted)', textTransform: 'uppercase', fontWeight: '700' }}>vCPU</div>
                    <div style={{ fontSize: '14px', fontWeight: '600', marginTop: '2px', color: 'var(--g1-text)' }}>{vm.vcpu} Cores</div>
                  </div>
                  <div style={{ background: 'var(--g1-nav)', padding: '10px', borderRadius: '8px', border: '1px solid var(--g1-border)' }}>
                    <div style={{ fontSize: '10px', color: 'var(--g1-muted)', textTransform: 'uppercase', fontWeight: '700' }}>RAM</div>
                    <div style={{ fontSize: '14px', fontWeight: '600', marginTop: '2px', color: 'var(--g1-text)' }}>{vm.ram_gb} Go</div>
                  </div>
                  </div>
              ...
              <div style={{ display: 'flex', borderTop: '1px solid var(--g1-border)', background: 'var(--g1-nav)' }} onClick={e => e.stopPropagation()}>
                <button 
                  className="btn-vm" 
        ...
        {vms.length === 0 && (
          <div style={{ gridColumn: '1 / -1', padding: '80px', textAlign: 'center', background: 'var(--g1-card)', borderRadius: '16px', border: '1px dashed var(--g1-border)' }}>
             ...
             <h3 style={{ fontSize: '20px', fontWeight: '700', color: 'var(--g1-text)' }}>Aucune VM pour le moment</h3>
