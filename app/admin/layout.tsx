        ...
        <div className="sidebar">
          ...
          <div className="logo-wrap">
            <div className="logo-mark">
              ...
              <div><div className="logo-name">Horizon Sigma</div><div className="logo-sub" style={{ color: 'var(--g1-accent2)' }}>Admin Portail</div></div>
            </div>
          </div>
          ...
          <div className="nav-wrap">
            <div className="nav-group">
              ...
              <Link href="/admin/noeuds" className="nav-item">
            ...
            <div className="nav-group">
              ...
              <Link href="/admin/reservations" className="nav-item">
                <svg viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/></svg>
                Réservations
              </Link>
              <Link href="/admin/bibliotheque" className="nav-item">
                <svg viewBox="0 0 24 24"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>
                Bibliothèque OS
              </Link>
              <Link href="/admin/utilisateurs" className="nav-item">
          ...
          <div className="sidebar-footer">
            <div className="user-row">
              ...
              <div style={{ minWidth: '0', flex: '1' }}>
                <div className="user-name">Admin Sigma</div>
